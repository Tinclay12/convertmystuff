...
type GenericRealEstateCalculatorToolProps = {
  toolId: string;
};

export const GenericRealEstateCalculatorTool = ({
  toolId,
}: GenericRealEstateCalculatorToolProps) => {
  const config = realEstateCalculatorConfigs[toolId];
  ...
  return (
    <div className="space-y-4">
      <ToolInputPanel title="Property inputs">
